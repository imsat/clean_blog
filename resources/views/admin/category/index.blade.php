...
{{--                                        <a href="{{route('categories.edit', $category->id)}}" class="btn btn-primary btn-sm">Edit</a>--}}
                                        <button type="button" onclick="openCategoryEditModal({{$category->id}})" class="btn btn-primary btn-sm">Edit</button>
{{--                                        <a href="{{route('categories.show', $category->id)}}"--}}
{{--                                           class="btn btn-info btn-sm">--}}
{{--                                            View--}}
{{--                                        </a>--}}
                                        <button type="button" onclick="openShowCategoryModal({{$category->id}})" class="btn btn-info btn-sm">
                                            View
                                        </button>
